...
<head>
    ...
    <title>Solicitar Cita con Laboratorio</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form action="CitaLab.jsp" method="POST">
            ...
            <select id="Ced_Medico" name="Ced_Medico" required>
                ...
                try {
                    ...
                    String consultaSQL = "SELECT Ced_Medico, Nom_Medico FROM Medico WHERE Categoria = 'Medico Laboratorio'";
