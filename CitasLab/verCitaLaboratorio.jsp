...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-color: #0270ca; /* Color de fondo azul */
            color: #333;
        }
        .container {
            max-width: 800px;
...
<body>
 <%
    ...
    try {
        ...
        String consultaSQL = "SELECT Citas_Lab.ID_Lab, Citas_Lab.Descripcion_Lab, Citas_Lab.Fecha_CLab, Citas_Lab.Hora, Medico.Nom_Medico " +
                             "FROM Citas_Lab " +
                             "JOIN Medico ON Citas_Lab.Ced_Medico = Medico.Ced_Medico";
